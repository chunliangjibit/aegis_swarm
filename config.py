# Aegis Swarm 2.0 - Configuration File (Final Cleaned Version)
...
WEAPON_TEMPLATES = {
    "SUICIDE_FRAG_V1": {
        "type": "suicide_aoe", "detonation_range": 15.0, "kill_radius": 25.0,
        "damage_radius": 55.0, "kill_prob": 0.95, "base_damage": 80
    },
    "PULSE_LASER_V1": {
        "type": "dps", "weapon_range": 100.0, "damage_per_second": 20
    }
}
ROLE_TEMPLATES = {
...
TEAM_BLUE_CONFIG = {
    ...
    "swarm_composition": {
        "bait_scouts": { "role_template": "SCOUT_CHASSIS", "weapon_template": None, "count": 5, "boids_weights": {"separation": 3.0, "alignment": 0.3, "cohesion": 0.2}, "strategy": "bait_and_observe" },
        "strikers": { "role_template": "STRIKER_CHASSIS", "weapon_template": "SUICIDE_FRAG_V1", "count": 45, "boids_weights": {"separation": 1.8, "alignment": 0.5, "cohesion": 0.4}, "strategy": "wait_for_hva_and_strike" }
    }
}
TEAM_RED_CONFIG = {
